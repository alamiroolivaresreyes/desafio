...
############Ejercicios realizados por Alamiro Olivares###########
...
function largoDelNombre(nombre = "") {
  nombre = nombre.toLowerCase();
    ...
    //Detectar caracteres fuera del alfabeto
    for (let i=0; i < longitud; i++) {
        if (alfabeto.includes(nombre[i])) {
        }else {
            return "El parámetro recibido es invalido";
        }
      }
    //Medición del largo del nombre ingresado
    if (longitud<=5){
...
function contarTipoNumber(arreglo = []) {
  let cant = 0
  for(let i=0; i < variosTiposArray.length ; i++ ){
      if(typeof(variosTiposArray[i]) == "number"){
          cant = cant+1;
      }
  }
  return cant;   
...
function obtenerCantidadDePares(numero1, numero2) {
  ...
  return `La cantidad de números pares obtenido fue de ${cantidadPares} `
...
function obtenerTelefonoPeru(econtact = {}) {
  let telefono = econtact.datos.sedes.Peru.telefono;
...
function obtenerPaisesConTelefono(econtact = {}) {
  let sedes = econtact.datos.sedes;
    let cantidadPaises = 0;
    for(i in sedes){
        if(econtact['datos']['sedes'][i]['telefono'] != undefined){
            cantidadPaises++;
        }
    }
...
function cargarArreglo(numero) {
  if(numero <= 0){
    ...
    return "No entendi el ejercicio en el caso de no volver a pasar el arreglo de vuelta a la funcion mas el numero";
}
//! =======================================================================================================================================================
...
function divisiblesPorCinco(numeros = []) {
  let cantidad = 0;
    ...
    return "La cantidad de numeros divisibles por 5 son:" + cantidad;
}
//! =======================================================================================================================================================
...
function sumatoria(numeros = []) {
  ...
  return "La sumatoria de los números es: " + sumatoria;
}
//! =======================================================================================================================================================
...
function verificarCantidadEmpleados(econtact = {}) {
  let num_empleados = econtact.datos.empleados;
    let sedes = econtact.datos.sedes;
    let sum_empleados = 0;
    for(i in sedes){
        sum_empleados = sum_empleados + econtact['datos']['sedes'][i]['empleados'];
    }
    if(num_empleados == sum_empleados){
        return true;
    }else{
        return false;
    }
...
function validarArreglo(numeros = []) {
  ...
  if(numeros.length >= 6){
      ...
      return "Arreglo ingresado debe tener al menos 6 numeros."
  }
}
//! =======================================================================================================================================================
...
return "No existe el numero en el arreglo.";
}
//! =======================================================================================================================================================
...
function verificarCantidadEmpleados(econtact = {}, cantidad) {
  let sedes = econtact.datos.sedes;
  let cantSedesMenor = 0;
  for(i in sedes){
      if(sedes[i].empleados<cantidad){
          cantSedesMenor++;
      }
  }
  return "La cantidad de sedes con un numero de empleados menor a " + cantidad + " son " + cantSedesMenor;
}
//! =======================================================================================================================================================
...
function quitarParteDecimal(arregloNumerosReales = []) {
  let arraySinDecimales = []; 
    for(i=0;i<arregloNumerosReales.length;i++){
        arraySinDecimales[i] = Math.trunc(arregloNumerosReales[i]);
    }
    return arraySinDecimales;
}
